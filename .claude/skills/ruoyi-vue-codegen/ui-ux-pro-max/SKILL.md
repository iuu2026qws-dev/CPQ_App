---
name: ui-ux-pro-max
description: "用户界面/用户体验设计智能。50 种风格，21 种调色板，50 种字体搭配，20 种图表，8 种技术栈（React、Next.js、Vue、Svelte、SwiftUI、React Native、Flutter、Tailwind）。操作：规划、构建、创建、设计、实施、审查、修复、改进、优化、增强、重构、检查用户界面/用户体验代码。项目：网站、着陆页、仪表板、管理面板、电子商务、软件即服务、作品集、博客、移动应用程序、.html、.tsx、.vue、.svelte。元素：按钮、模态框、导航栏、侧边栏、卡片、表格、表单、图表。风格：玻璃质感、黏土质感、极简主义、粗野主义、新拟态、便当网格、暗黑模式、响应式、拟物化、扁平化设计。主题：调色板、可访问性、动画、布局、排版、字体搭配、间距、悬停、阴影、渐变。"
---
